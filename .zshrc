...
# alias gohttp="gobuster dir -u $1 -w /usr/share/wordlists/dirb/common.txt -q -t 25 -x php,html,txt,xml"
# alias gohttpmedium="gobuster dir -u $1 -w /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt -q -t 50 -x php,html,txt,xml"
alias allports="nmap -p- --min-rate 10000 -oN allports"
#alias allservices="nmap -Pn -sV -sC -p$1 -oN serviceports $2"
